...
def subscribe():
    ...
    subscriptions = [
        {"pubsubname": "messagebus", "topic": "cluster-create", "route": "create-cluster"},
        {"pubsubname": "messagebus", "topic": "cluster-start", "route": "start-cluster"},
        {"pubsubname": "messagebus", "topic": "cluster-stop", "route": "stop-cluster"},
        {"pubsubname": "messagebus", "topic": "cluster-delete", "route": "delete-cluster"},
        {"pubsubname": "messagebus", "topic": "cluster-plan-upgrade", "route": "update-cluster-plan"},
    ]
