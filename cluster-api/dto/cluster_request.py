"""DTOs for cluster API: request models."""
...
class ClusterRequest(BaseModel):
    """Request model for creating a Kubernetes cluster."""
    ...
    class Config:
        """Pydantic configuration for cluster_request, including schema examples."""
