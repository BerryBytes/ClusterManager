"""FastAPI application for cluster management API.

This module defines the FastAPI app, middleware, database startup/shutdown events,
...
def startup_db_client():
    """Initialize MongoDB client and seed database if necessary."""
...
app.include_router(
    kube_route, tags=["kubeversion"], prefix="/v1/kubeversion", dependencies=PROTECTED
)
app.include_router(
    user_route, tags=["user"], prefix="/v1/users", dependencies=PROTECTED
)
app.include_router(
    cluster, tags=["cluster"], prefix="/v1/clusters", dependencies=PROTECTED
)
