...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='WebSocket Client for Cluster Status Updates')
    parser.add_argument('--user', '-u', default='test-user', help='User ID to connect with')
    parser.add_argument('--server', '-s', default='ws://localhost:8000', help='WebSocket server URL')
    parser.add_argument('--no-ping', action='store_true', help='Disable periodic ping messages')
